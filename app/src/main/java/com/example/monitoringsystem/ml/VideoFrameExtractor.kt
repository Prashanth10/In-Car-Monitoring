        ...
        suspendCancellableCoroutine { continuation ->
            ...
            fun checkBitmapPixels(bitmap: Bitmap) {
                try {
                    ...
                    Log.d("InCarMonitoring", "Extract Pixel sample from top-left ${sampleSize}x${sampleSize}")
                    Log.d("InCarMonitoring", "Extract Non-zero pixels: $nonZeroPixels / ${pixels.size}")
            ...
            try {
                when (surfaceView) {
                        ...
                        PixelCopy.request(
                            ...
                            { result ->
                                if (result == PixelCopy.SUCCESS) {
                                    ...
                                    Log.e("InCarMonitoring", "PixelCopy failed for SurfaceView: $result")
                                    continuation.resume(null)
                                }
                            },
                            handler
                    ...
                    is android.view.TextureView -> {
                        ...
                        PixelCopy.request(
                            ...
                            { result ->
                                ...
                                if (result == PixelCopy.SUCCESS) {
                                    ...
                                    Log.e("InCarMonitoring", "PixelCopy failed for Surface: $result")
                                    continuation.resume(null)
                                }
                            },
                            handler
                        ...
                        Log.e("InCarMonitoring", "Unsupported video surface type: ${surfaceView::class}")
                        continuation.resume(null)
                    }
                }
            } catch (e: Exception) {
